...
// =====================================================
    ...
    private fun showModeChooser() {
        ...
        listOf(
            ...
            "Quick" to "Short and fast answers",
            "Balanced" to "Clear answers with useful detail",
            "Research" to "Thorough analysis and sources",
            "Teacher" to "Step-by-step explanations"
...
""".trimIndent()
    ...
    private fun isImageGenerationRequest(message: String): Boolean {
        ...
        val commands = listOf(
            ...
            "create image", "make an image", "make image",
            "draw an image", "draw image", "generate a picture",
            "create a picture", "make a picture", "picture of",
            "image of"
        )
        return commands.any { text.startsWith(it) || text.contains("please $it") }
    }
    ...
    private fun extractImageGenerationPrompt(message: String): String {
        val prefixes = listOf(
            "please generate an image of", "please create an image of",
            "please make an image of", "generate an image of",
            "create an image of", "make an image of", "draw an image of",
            "generate image of", "create image of", "make image of",
            "generate a picture of", "create a picture of",
            "make a picture of", "picture of", "image of",
            "generate an image", "create an image", "make an image",
            "generate image", "create image", "make image"
        )
        var prompt = message.trim()
        prefixes.firstOrNull {
            prompt.lowercase(Locale.ROOT).startsWith(it)
        }?.let { prefix ->
            prompt = prompt.substring(prefix.length).trimStart(' ', ':', '-', ',')
        }
    ...
    private fun loadOrCreateConversation(
        ...
        Thread {
            ...
            currentConversationId = if (restoredConversationId != 0L) {
