...
class WakeWordService : Service() {
    ...
    companion object {
        ...
        const val ACTION_PAUSE =
            "com.example.choppermobile.PAUSE_WAKE_WORD"

        const val ACTION_RESUME =
            "com.example.choppermobile.RESUME_WAKE_WORD"
    ...
    private fun handleWakeWordDetected(
        ...
        // Release the microphone before MainActivity starts Android speech
        // recognition. Two microphone clients cannot listen at the same time.
        stopWakeWordListening()
